...
<template>
  <NFlex vertical class="w-300px">
    ...
    <NTree
      ...
      class="h-full"
    ></NTree>
    <NButton type="primary" class="w-full" @click="addHandle">
      新增
      <template #icon>
  ...
  />
  <DictDetailModal v-model:visible="visible" v-model:row-id="rowId" :operate-type="operateType" @submitted="submited" />
</template>
