  ...
  const opts: DropdownOption[] = [
    {
      ...
      icon: SvgIconVNode({ localIcon: 'close', fontSize: 18 })
    },
    {
      key: 'closeOther',
      label: $t('dropdown.closeOther'),
      icon: SvgIconVNode({ localIcon: 'shrink', fontSize: 18 })
    },
    {
      key: 'closeLeft',
      label: $t('dropdown.closeLeft'),
      icon: SvgIconVNode({ localIcon: 'arrow-left', fontSize: 18 })
    },
    {
      key: 'closeRight',
      label: $t('dropdown.closeRight'),
      icon: SvgIconVNode({ localIcon: 'arrow-right', fontSize: 18 })
    },
    {
      key: 'closeAll',
      label: $t('dropdown.closeAll'),
      icon: SvgIconVNode({ localIcon: 'close-circle', fontSize: 18 })
    }
  ];
